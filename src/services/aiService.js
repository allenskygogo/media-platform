...
function buildSocialPostResult(input) {
  ...
  return {
    ...
    platforms: {
      ...
      threads: {
        firstParagraphHook: `我現在最怕看到的文案，是那種每一句都對，但每一句都不像人講的。`,
        readyPost: `我現在最怕看到的文案，是那種每一句都對，但每一句都不像人講的。\n\n做${topic}也是。\n\n太完整、太標準、太像懶人包，反而很容易被滑掉。\n\n觀眾想看的不是你把資料整理得多乾淨。\n是你看到這件事時，真正想講哪一句話。\n\n先把那句話找出來，再修文案。\n\n#內容創作 #社群文案 #自媒體`,
        shortVersion: `如果一篇文拿掉你的名字，任何人都能發，那它大概還不夠像你。`,
        boldVersion: `不要急著把文案寫漂亮。先讓它像人說話。`,
