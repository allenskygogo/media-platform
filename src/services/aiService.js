...
function buildSocialAngles(topic) {
  ...
  return [
    {
      category: '批判',
      name: `批判：別再把${base}寫成誰都能講的漂亮話`,
      platforms: ['IG', 'Facebook'],
      trigger: '不爽、戳破、替正在努力的人出氣',
      reason: '有立場的批判容易讓讀者覺得被說中，也更願意轉給同樣有感的人',
    },
    {
      category: '溫馨',
      name: `溫馨：做${base}的人，其實只是想被真正看見`,
      platforms: ['Facebook', 'Instagram'],
      trigger: '被理解、被安慰、被輕輕提醒',
      reason: '柔軟的口吻能讓讀者降低防備，適合收藏或私訊延伸',
    },
    {
      category: '開心',
      name: `開心：原來${base}也可以有一點小小的成就感`,
      platforms: ['TikTok', 'YouTube'],
      trigger: '輕鬆、驚喜、想分享一個好消息',
      reason: '正向情緒容易讓人想回應自己的經驗，也適合做成日常感貼文',
    },
    {
      category: '分析',
      name: `分析：從${base}看出真正影響結果的原因`,
      platforms: ['IG', 'Facebook'],
      trigger: '看懂原因、整理脈絡、找到判斷依據',
      reason: '清楚分析能讓讀者感覺事情被說明白，適合保存和轉傳',
    },
  ]
}
...
function buildSocialPostResult(input) {
  ...
  return {
    strategy: {
      ...
      platformDifference: 'IG 重點放收藏與分享；Facebook 重點放故事與討論；YouTube 重點放搜尋與觀看理由；TikTok 重點放前三秒停留',
      claim: `做${topic}，真正拉開差距的不是更努力，而是先看懂問題在哪裡。`,
      coreHook: angleName,
      emotion: '讓讀者感覺被理解，也看到下一步能怎麼修正',
      ctaDirection: '用像真人聊天的方式收尾，讓讀者願意丟出自己的例子',
      risk: '避免叫人無腦留言、避免空泛口號、避免堆疊無關 hashtag',
    },
    platforms: {
      ig: {
        firstParagraphHook: `昨天有人問我：「我是不是要每天發，才比較有機會被看見？」`,
        readyPost: `昨天有人問我：「我是不是要每天發，才比較有機會被看見？」\n\n我第一個反應不是叫他加量。\n\n因為很多帳號的問題，不是發太少。\n是每一篇都太像在對所有人講話。\n\n看起來很努力。\n但觀眾滑過去的時候，不會覺得「這跟我有關」。\n\n如果你現在也在做${topic}，我會先檢查一件事：\n這篇文到底是寫給誰看的？\n\n這句話沒想清楚，每天發也只是每天消耗自己。\n\n#自媒體經營 #內容創作 #社群文案 #短影音`,
        shortVersion: `每天發文不一定有用。\n如果每一篇都像在跟所有人說話，最後通常誰都不會停下來。`,
        boldVersion: `你以為你缺發文頻率，其實你缺的是一個讓觀眾覺得「這篇是在講我」的切口。`,
        hashtags: '#自媒體經營 #內容創作 #社群文案 #短影音',
        firstComment: `我通常會先問：這篇文是寫給誰看的？他看到時會有什麼反應？`,
        visualNote: `畫面可用深色背景搭配三段關鍵字：「受眾」「問題」「記憶點」。Alt text：一張說明${topic}內容定位順序的社群貼文圖。`,
      },
      fb: {
        firstParagraphHook: `有個學員問我：「我已經很認真發了，為什麼還是沒什麼人看？」`,
        readyPost: `有個學員問我：「我已經很認真發了，為什麼還是沒什麼人看？」\n\n我看了一下他的內容。\n其實不是不好。\n也不是不努力。\n\n只是每一篇都太安全了。\n像是在把正確答案寫出來，但沒有把自己的判斷講出來。\n\n做${topic}最可惜的地方是這樣：\n你明明有經驗，卻寫得像網路上任何人都可以說的話。\n\n觀眾不會因為你講得很完整就記住你。\n觀眾會記住的是：\n你把他心裡那句話，講得比他自己還清楚。\n\n所以我現在看內容，會先看它有沒有「人味」。\n有沒有現場感。\n有沒有一句話，是只有這個人會這樣說。\n\n沒有的話，再漂亮都很容易滑過去。\n\n#自媒體經營 #內容創作 #社群文案 #個人品牌`,
        shortVersion: `做${topic}之前，先把一句話講清楚：你想對誰說？你希望他看完有什麼感覺？`,
        boldVersion: `文案太正確，有時候反而沒人想看。因為大家要看的不是標準答案，是你真的怎麼想。`,
        hashtags: '#自媒體經營 #內容創作 #社群文案 #個人品牌',
        firstComment: `我現在判斷一篇文能不能用，會先看它有沒有一句「只有本人會講」的話。`,
        visualNote: `可搭配一張「內容定位檢查表」。Alt text：用三個問題協助創作者檢查${topic}社群內容方向。`,
      },
      youtube: {
        firstParagraphHook: `我現在最怕看到的影片文案，是那種每一句都對，但每一句都不像人講的。`,
        readyPost: `我現在最怕看到的影片文案，是那種每一句都對，但每一句都不像人講的。\n\n做${topic}也是。\n\n太完整、太標準、太像懶人包，反而很容易被滑掉。\n\n觀眾想看的不是你把資料整理得多乾淨。\n是你看到這件事時，真正想講哪一句話。\n\n先把那句話找出來，再拍內容。\n\n#內容創作 #社群文案 #自媒體`,
        shortVersion: `如果一支影片拿掉你的名字，任何人都能拍，那它大概還不夠像你。`,
        boldVersion: `不要急著把影片文案寫漂亮。先讓它像人說話。`,
        hashtags: '#內容創作 #社群文案 #自媒體',
        firstComment: `我會先抓原文裡最像本人講話的那一句，再往外修。`,
        visualNote: `可用純文字截圖風格。Alt text：一段提醒創作者先定位再追技巧的影片文案。`,
      },
      tiktok: {
        firstParagraphHook: `你有沒有看過那種很正確，但完全不像真人會講的影片？`,
        readyPost: `你有沒有看過那種很正確，但完全不像真人會講的影片？\n\n做${topic}最怕就是這樣。\n講得很完整，但觀眾完全感覺不到你這個人。\n\n先不要急著塞重點。\n先抓一句最像你、也最能讓觀眾停下來的話。\n\n文案像人，影片才有記憶點。\n\n#內容創作 #短影音 #自媒體`,
        shortVersion: `影片文案不是越完整越好，是要先讓人感覺這是你真的想講的話。`,
        boldVersion: `觀眾不是不愛學，是不想看一支不像真人講話的教學影片。`,
        hashtags: '#內容創作 #短影音 #自媒體',
        firstComment: `先找一句真人會說的話，再決定怎麼拍。`,
        visualNote: `可搭配口播畫面或字幕重點。Alt text：創作者用口語方式說明${topic}內容切角。`,
      },
    },
  }
}
    ...
    case 'account': {
      ...
      return {
        ...
        topicSets: {
          ...
          process: [
            `紀錄我做一個${industry}專案的完整過程`,
            `對比五款${industry}工具，哪一款最適合新手`,
            `挑戰一天完成一個可落地的${industry}成果`,
            `當一天${industry}新手，體驗從零學起的真實感受`,
            `公開我幫客戶規劃${industry}方案的全流程`,
            `實測三種${industry}方法，哪一種最快看到效果`,
            `限時三小時完成一份${industry}交付，結果會怎樣`,
            `角色互換：我當學員重新學一次${industry}，才知道哪裡最難`,
          ],
        },
      }
    }
