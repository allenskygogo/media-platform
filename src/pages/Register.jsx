  ...
  return <div className="entry-page">
    ...
    <main className="entry-main">
      <section className="entry-intro">
        ...
        <h1>申請 AI 使用</h1>
        <p>AI 可獨立申請，目前開放免費使用。由課程顧問協助建立 AI 會員帳號，不需要先購買課程。</p>
      </section>
      <section className="entry-card" aria-label="AI 申請方式">
        <h2>透過課程顧問申請</h2>
        <ol style={{ paddingLeft: 24, margin: '20px 0' }}>
          <li>加入課程顧問 LINE，跟顧問說「我要申請 AI 使用」。</li>
          <li>提供姓名與要使用的 Email；已有會員帳號請提供原本的 Email。</li>
          <li>收到開通通知後，回到網站登入使用。</li>
        </ol>
        <p>送出 LINE 訊息後，需由課程顧問確認開通。</p>
        <div className="entry-actions">
          <a className="sp2-btn sp2-btn-primary" href={LINE_OFFICIAL_URL} target="_blank" rel="noopener noreferrer">加入課程顧問 LINE</a>
