...
const MOCK_SCRIPTS = {
  ...
  story: text => [
    ...
    {
      heading: '【困境與轉機】',
      body:    `困難：盲目自信\n一開始我以為這件事很簡單。反正我已經看過很多案例，也學了很多方法，我就覺得自己照著做應該很快會有結果。結果做了幾週，成績很普通，時間花掉了，錢也花掉了，最尷尬的是我還不敢跟身邊的人說。\n\n轉機：通關密碼\n後來我才發現，問題不是我不努力，而是我根本沒有把順序搞清楚。那天晚上我把所有做過的事寫在紙上，一項一項圈起來，才發現我一直在做看起來很忙、但不會帶來結果的事。\n\n困難：過河拆橋\n本來以為方向調整後會慢慢變好，結果又遇到更麻煩的事。原本一起做的人開始不配合，有些承諾好的事情臨時變卦，原本談好的資源也突然沒了。那幾天我手機一響就緊張，因為不是壞消息，就是要我再補洞。\n\n轉機：貴人相助\n真正的轉機，是有一個懂這件事的人看完我的狀況後，直接跟我說：「你不是沒有能力，你是把力氣用錯地方。」他幫我把流程重新排過，我也照著一步一步修。後來第一個成果出來的時候，我不是興奮到大叫，而是坐在椅子上很久，心裡只想：原來真的走得出來。`,
    },
    {
      heading: '【感悟與收束】',
