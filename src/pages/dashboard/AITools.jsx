...
const STORY_SCRIPT_SOP = {
  ...
  qualityRules: [
    ...
    '困境與轉機最好寫兩輪：困難1、轉機1、困難2、轉機2。第二個困難要比第一個更難，第二個轉機要比第一個更有力。',
...
const STORY_SCRIPT_GENERATION_INSTRUCTION = [
  ...
  '困境與轉機要有情緒曲線。不要一帆風順。請優先寫成「困難1（橋段名）→轉機1（橋段名）→困難2（橋段名）→轉機2（橋段名）」。第一輪困境要比第二輪輕，第二輪轉機要比第一輪更有力。',
  '每個困境與轉機都要有畫面、人物、事件、代價或結果；不要只寫「我遇到困難，後來找到方法」。',
  '困難1、轉機1、困難2、轉機2都必須寫成完整故事事件，不是框架說明。每一段至少 4 到 7 句，要有具體時間、場景、人物動作、對話或訊息、金錢或結果代價。',
...
const MOCK_SCRIPTS = {
  ...
  story: text => [
    ...
    {
      heading: '【困境與轉機】',
      body:    `困難1（盲目自信）：一開始我以為這件事很簡單。反正我已經看過很多案例，也學了很多方法，我就覺得自己照著做應該很快會有結果。結果做了幾週，成績很普通，時間花掉了，錢也花掉了，最尷尬的是我還不敢跟身邊的人說。\n\n轉機1（通關密碼）：後來我才發現，問題不是我不努力，而是我根本沒有把順序搞清楚。那天晚上我把所有做過的事寫在紙上，一項一項圈起來，才發現我一直在做看起來很忙、但不會帶來結果的事。\n\n困難2（過河拆橋）：本來以為方向調整後會慢慢變好，結果又遇到更麻煩的事。原本一起做的人開始不配合，有些承諾好的事情臨時變卦，原本談好的資源也突然沒了。那幾天我手機一響就緊張，因為不是壞消息，就是要我再補洞。\n\n轉機2（貴人相助）：真正的轉機，是有一個懂這件事的人看完我的狀況後，直接跟我說：「你不是沒有能力，你是把力氣用錯地方。」他幫我把流程重新排過，我也照著一步一步修。後來第一個成果出來的時候，我不是興奮到大叫，而是坐在椅子上很久，心裡只想：原來真的走得出來。`,
    },
    {
      heading: '【感悟與收束】',
