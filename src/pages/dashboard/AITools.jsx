...
const MOCK_SCRIPTS = {
  ...
  story: text => [
    ...
    {
      heading: '【困境與轉機】',
      body:    `困難：家門不幸\n那陣子我白天要上班，晚上還要處理家裡的事情。每次剛準備坐下來做「${text}」，手機就會響，不是家人臨時要幫忙，就是又有新的狀況要處理。有一天晚上十一點，我把電腦打開，畫面停在空白文件上快半小時，最後只打出兩行字。那時候我才發現，不是我不想努力，是我每天能完整安靜下來的時間真的太少。\n\n轉機：至親所託\n真正讓我撐下去的，是我媽那天在餐桌上跟我說：「我不懂你在做什麼，但我知道你不是玩玩而已。」她沒有教我方法，也沒有幫我找資源，只是把她對我的相信放在我面前。那句話像是把責任交到我手上，我突然覺得不能再用忙當藉口。隔天開始，我把每天二十分鐘固定下來，不追求完美，只要求今天一定交出一個小版本。\n\n困難：惡霸欺壓\n剛開始做出一點東西時，旁邊也有人冷嘲熱諷。有人說這樣太慢，有人說上班族哪有時間做起來，甚至有人直接笑我只是三分鐘熱度。最刺耳的是，有一次午休時，同事看著我準備的內容說：「你這樣做，誰會看？」我當下沒有回嘴，但那句話卡在心裡一整天，差點讓我把已經排好的計畫刪掉。\n\n轉機：破釜沈舟\n後來我乾脆不解釋了，直接把所有下班後的零碎時間都砸進去。三個月後，我做出第一個真正有成績的內容，原本笑我的那個同事，竟然私訊問我能不能幫他也規劃一套。更解氣的是，他還說：「你之前那套方法，我現在看懂了。」我盯著那行字看了很久，沒有急著回，只覺得胸口那口氣終於順了。以前他笑我沒人看，現在他反過來找我教他，這一刻我才知道，最爽的反擊不是吵贏，是你真的做成了。`,
    },
    {
      heading: '【感悟與收束】',
