...
- 當 input.scriptType = "story" 時，必須嚴格使用說故事腳本 SOP：
  ...
  第三段：【困境與轉機】。必須寫出困境和轉機。優先使用「困難1（橋段名）→轉機1（橋段名）→困難2（橋段名）→轉機2（橋段名）」；困境要逐層變難，轉機要逐層更有力。每個困境與轉機都要有具體畫面、人物、事件、代價或結果，不可只寫「遇到困難，後來找到方法」。
