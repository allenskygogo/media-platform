...
- 當 input.scriptType = "story" 時，必須嚴格使用說故事腳本 SOP：
  ...
  第三段：【困境與轉機】。必須寫出困境和轉機。優先使用「困難1（橋段名）→轉機1（橋段名）→困難2（橋段名）→轉機2（橋段名）」；困境要逐層變難，轉機要逐層更有力。每個困境與轉機都必須是具體故事事件，不是意思、摘要、分析或課程說明。每一輪至少 4 到 7 句，要有時間點、地點、人物動作、對話或訊息、金錢或結果代價。橋段名稱只是內部方向，不是正文內容。不要把「盲目自信、過河拆橋、貴人相助」寫成一句成語解釋，也不要順接成語；要把它翻成一整段事件。例如盲目自信不是寫「我太自信所以失敗」，而是寫：公司虧錢、宣傳片案子變少、新聞看到短視頻崛起、我以為十年導演背景做短視頻很簡單、接了客戶後播放量只有幾百、客戶打電話要退款、帳上沒錢只好借錢補洞。整段事件讓人自然感覺出「盲目自信」。禁止寫「第一輪困難是客戶因為...」「第一輪轉機是我...」「第二輪困難是...」這種摘要句；要直接寫成事件，例如「那天中午我正在吃飯，客戶突然打電話來...」「隔天早上他拿著檢查報告站在門口...」。要像編劇寫一場戲：困境要讓觀眾看見事情怎麼壞掉，轉機要讓觀眾看見事情怎麼被扭回來。
...
const STORY_EVENT_RULE = '當 scriptType=story 或腳本類型=說故事時，橋段名稱只是內部方向，不是正文內容。不要把「盲目自信、過河拆橋、貴人相助」寫成一句成語解釋，也不要順接成語；要把它翻成一整段事件。例如盲目自信不是寫「我太自信所以失敗」，而是寫：公司虧錢、宣傳片案子變少、新聞看到短視頻崛起、我以為十年導演背景做短視頻很簡單、接了客戶後播放量只有幾百、客戶打電話要退款、帳上沒錢只好借錢補洞。整段事件要讓觀眾自然感覺出「盲目自信」。'
